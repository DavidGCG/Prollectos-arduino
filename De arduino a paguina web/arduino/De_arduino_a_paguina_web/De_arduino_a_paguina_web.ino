...
int PIN_LED=13;//Configuramos el led en el pin 8
                ...
                if(readString.substring(LED,LED+5)=="LED=T")
                 {
                  ...
                  cliente.println("<title> De arduino a paguina web</title>");
                  cliente.println("</head>");
                  cliente.println("<body width=100% height=100%>");
                  cliente.println("<center>");
                  cliente.println("<br>");
                  
                  cliente.println("<h1> De arduino a paguina web</h1>");
                  cliente.println("<br>");
                  cliente.println("<input type=submit value=paguina web style=width:200px; height:75px onClick=location.href='http://localhost/arduino/index.html'>");
                  cliente.println("</center>");
